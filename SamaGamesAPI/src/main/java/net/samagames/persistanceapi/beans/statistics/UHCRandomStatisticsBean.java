 ...
 */
public class UHCRandomStatisticsBean
{
    /* Database Structure

    Table: uhcrandom_stats
    +---------------+------------+------+-----+---------------------+-------+
    ...
    */
    ...
    public UHCRandomStatisticsBean(UUID uuid, int damages, int deaths, int kills, int maxDamages, int playedGames, int wins, Timestamp creationDate, Timestamp updateDate, long playedTime)
    {
        this.setUuid(uuid);
