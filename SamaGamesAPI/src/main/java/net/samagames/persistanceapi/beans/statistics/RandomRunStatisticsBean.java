 ...
 */
public class RandomRunStatisticsBean
{
    /* Database Structure

    Table: randomrun_stats
    +---------------+------------+------+-----+---------------------+-------+
    ...
    */
    ...
    public RandomRunStatisticsBean(UUID uuid, int damages, int deaths, int kills, int maxDamages, int playedGames, int wins, Timestamp creationDate, Timestamp updateDate, long playedTime)
    {
        this.setUuid(uuid);
