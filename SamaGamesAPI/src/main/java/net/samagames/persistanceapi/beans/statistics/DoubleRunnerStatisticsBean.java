 ...
 */
public class DoubleRunnerStatisticsBean
{
    /* Database Structure

    Table: doublerunner_stats
    +---------------+------------+------+-----+---------------------+-------+
    ...
    */
    ...
    public DoubleRunnerStatisticsBean(UUID uuid, int damages, int deaths, int kills, int maxDamages, int playedGames, int wins, Timestamp creationDate, Timestamp updateDate, long playedTime)
    {
        this.setUuid(uuid);
